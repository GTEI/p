...
bot_token = '905726204:AAFGoW8_jE0mRr7zleAO-IJVIRVFYpwQGvA'
bot = telebot.TeleBot(bot_token)
user_data = {}
allowed_users = ['6627692']
admin_id = '6627692'
subscription_data = {}
...
btn_clear_all_info = telebot.types.InlineKeyboardButton('🗑️ مسح كل المعلومات', callback_data='clear_all_info')
...
def start(message):
    ...
    if user_id in allowed_users:
        ...
        bot.reply_to(message, 'اهلا بك في بوت الرفع الخارجي المطورين @SLOM9M, شرح البوت تابعه قبل لا تبدي @eeerxr', reply_markup=keyboard)
    else:
        bot.reply_to(message, 'انت غير مشترك في البوت للاشتراك في البوت : @eeerxr')
...
def show_admin_commands(message):
    if str(message.from_user.id) == '6627692':  
